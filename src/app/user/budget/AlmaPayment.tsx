...
export default function AlmaPayment({ totalPrice }: { totalPrice: number }) {
  ...
  return (
    <section className="bg-white p-8 text-black">
      <div className='bg-[url("/images/budget/almaBg.png")] h-[327px] bg-cover pl-[39%]'>
        ...
        <p className="text-sm pr-8 mb-4 mt-2">
          Te ofrecemos una experiencia de compra más flexible con el pago en 2,
          3 o 4 plazos.
        </p>
        <div className="flex gap-1 text-[11px] text-center">
          <div className="flex flex-col gap-1">
            <p className="rounded-md bg-[#FFC738]/10 py-1 px-2">
              Pago aplazado
            </p>
            <p className="rounded-md bg-[#FFC738]/20 py-1 px-2 font-semibold text-left">
              En 2 plazos
            </p>
            <p className="rounded-md bg-[#FFC738]/20 py-1 px-2 font-semibold text-left">
              En 3 plazos
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="rounded-md bg-white py-1 px-2">
              {`${priceFormat(Number(prices.twoStepsPrice))}`} €
            </p>
            <p className="rounded-md bg-white py-1 px-2">
              {`${priceFormat(Number(prices.threeStepsPrice))}`} €
            </p>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="rounded-md bg-white py-1 px-2">
              {`${lastTermPrice(prices.twoStepsPrice, 2)}`} €
            </p>
            <p className="rounded-md bg-white py-1 px-2">
              {`${priceFormat(Number(prices.threeStepsPrice))}`} €
            </p>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="rounded-md bg-white py-1 px-2">
              {`${lastTermPrice(prices.threeStepsPrice, 3)}`} €
            </p>
            <p className="rounded-md bg-white py-1 px-2">
              {`${priceFormat(Number(prices.fourStepsPrice))}`} €
            </p>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="py-1 px-2">&nbsp;</p>
            <p className="rounded-md bg-white py-1 px-2">
              {`${lastTermPrice(prices.fourStepsPrice, 4)}`} €
            </p>
          </div>
        </div>
        <Image
          className="ml-auto mr-10 mt-4"
          src="/images/budget/almaLogo.svg"
          height="20"
          width="74"
          alt="Alma"
        />
