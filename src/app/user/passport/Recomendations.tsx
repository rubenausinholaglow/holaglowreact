...
export default function Recomendations({
  ...
  return (
    <section>
      <div className="inline-flex justify-center items-center bg-hg-purple rounded-r-3xl text-white py-3 px-16">
        ...
        <p className="bg-hg-purple p-1 -ml-3 mr-8">682 417 208</p>
        <div className="flex">
          <div className="flex justify-center items-center border border-white rounded-full p4 h-[56px] w-[56px]">
            <SvgEnvelopeOpen height={24} width={24} fill="white" />
          </div>
        </div>
        <p className="bg-hg-purple p-1 -ml-3">hola@holaglow.com</p>
      </div>

      <div className="bg-hg-purple100/20 p-16 pb-6 -mt-10">
          ...
          {filteredFirst24Tips.length > 0 && (
            <div className="w-1/2 flex flex-col items-center mr-2">
              ...
              <ul className="bg-white text-xs rounded-xl p-8 text-center shadow-[0px_8px_16px_0px_rgba(0,0,0,.1)]">
                <li className="text-hg-purple mb-8">
                  ...
                  return (
                    <>
                      ...
                      {index + 1 < filteredAfter24Tips.length && (
                        <hr className="w-1/2 mx-auto h-[1px] bg-hg-purple300 m-3" />
                      )}
                    </>
                  );
                })}
