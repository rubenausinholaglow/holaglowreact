...
export default function Recomendations({
  ...
  return (
    <section>
      <div className="inline-flex justify-center items-center bg-hg-tertiary rounded-r-3xl text-white py-3 px-16">
      ...
      <div className="bg-hg-tertiary500/20 p-16 pb-6 -mt-10">
          ...
          {filteredFirst24Tips.length > 0 && (
            <div className="w-1/2 flex flex-col items-center mr-2">
              ...
              <ul className="bg-white text-xs rounded-xl p-8 text-center shadow-[0px_8px_16px_0px_rgba(0,0,0,.1)]">
                <li className="text-hg-tertiary mb-8">
                  ...
                  return (
                    <>
                      ...
                      {index + 1 < filteredFirst24Tips.length && (
                        <hr className="w-1/2 mx-auto h-[1px] bg-hg-pink/30 m-3" />
                      )}
                    </>
                  );
                })}
                  ...
                  return (
                    <>
                      ...
                      {index + 1 < filteredAfter24Tips.length && (
                        <hr className="w-1/2 mx-auto h-[1px] bg-hg-tertiary500 m-3" />
                      )}
                    </>
                  );
                })}
