...
export default function Issues() {
  return (
    <section className="mb-8">
      <div className="p-16 bg-hg-purple text-white flex flex-col justify-center items-center">
      ...
      <div className="text-hg-purple flex flex-col items-center py-6 px-24">
