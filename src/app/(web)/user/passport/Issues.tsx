...
export default function Issues({ appointment }: { appointment: Appointment }) {
  ...
  return (
    <section className="py-8 px-16 bg-hg-primary/10 text-xs text-hg-black">
      <h3 className="text-xl text-hg-tertiary font-semibold text-center mb-8">
        {issuesTitle}
      </h3>
      <div className="flex gap-16">
        {filteredNormalIssues.length > 0 && (
          <div className="w-1/2">
            <p className="text-hg-tertiary mb-4">Es normal si...</p>
            <ul className="mb-8">
        ...
        {filteredUnalarmingIssues.length > 0 && (
          <div className="w-1/2">
            <p className="text-hg-tertiary mb-4">No te alarmes si...</p>
            <ul className="mb-8">
