        ...
        <Flex layout="col-left" className="gap-4">
          <ul className="pt-8 mt-6 border-t border-hg-black300 w-full list-disc pl-6 flex flex-col gap-4 mb-20">
            <li>
              ...
              íntegramente entre el 13/11/2023 y el 27/11/2023, ambos incluidos.
            </li>
            <li>
              La promoción solo aplica a los tratamientos indicados en la página
              web (Packs Black Friday).
            </li>

            <li>La promoción no es acumulable a otras promociones activas.</li>
          </ul>
        </Flex>
      </Container>
    </MainLayout>
