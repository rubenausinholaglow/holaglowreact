      ...
      <MainLayout>
        ...
        <Container className="py-8 md:py-12">
          <Title className="mb-8">
            Bases de la promoción “Trae a un amigo”
          </Title>
          <Flex layout="col-left" className="gap-4">
            <p>
              La promoción será válida hasta el 31/12/2023. Holaglow se reserva
              el derecho de finalizar la promoción anticipadamente.
            </p>
            ...
            <ul className="pt-8 mt-6 border-t border-hg-black300 w-full list-disc pl-6 flex flex-col gap-4 mb-20">
              ...
              <li>
                ...
                amigo&quot; como quieras y canjearlos por separado o
                conjuntamente en tratamientos para ti. La promoción no es
                acumulable a otras ofertas y promociones.
              </li>

              <li>
                Los bonos conseguidos como referidor o a través de una
                invitación no son transferibles.
              </li>
            </ul>
          </Flex>
        </Container>
