...
export default function AboutUs({ isDerma = false }: { isDerma?: boolean }) {
  ...
  return (
    <Wrapper>
        ...
        <Container>
          <div className="md:flex md:flex-row gap-12 items-center">
            <Flex layout="col-left" className="md:w-1/2 mb-4 md:mb-0">
              ...
              <Text isAnimated size={isMobile ? 'md' : 'lg'} className="">
      ...
      {isDerma ? (
        <div className="bg-derma-primary500/10">
              ...
              <ul className="flex flex-col gap-12">
                <li className="flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div>
                    ...
                    <Text isAnimated className="text-hg-black500 md:text-lg">
                      ...
                      contamos sin tabúes todo lo que debes saber para que
                      pongas tus propias reglas. Creemos que la belleza real se
                ...
                <li className="flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div>
                    ...
                    <Text isAnimated className="text-hg-black500 md:text-lg">
                      ...
                      experiencia hecha a la medida de todas las personas que
                      ven en la medicina estética el mejor aliado para
                      deslumbrar en su día a día.
                    </Text>
                  </div>
                </li>
                ...
                <li className="flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div>
                    ...
                    <Text isAnimated className="text-hg-black500 md:text-lg">
                      Tus objetivos son los nuestros. Nuestro equipo médico
                      experto selecciona cada producto especialmente para ti,
                      ajustándose a tus necesidades y deseos. Queremos que
                      disfrutes de tu glow.
                    </Text>
                  </div>
                </li>
              </ul>
              ...
              <Flex layout="col-left" className="md:flex-row gap-8 md:gap-12">
                <div>
                  ...
                  <Text className="text-hg-black500">
                    Nuestros doctores expertos en medicina estética cuentan con
                    una extensa experiencia que les permite aplicar nuestra
                    selección de tratamientos con la mayor seguridad.
                  </Text>
                </div>
                <div>
                  <Text size="xl" className="font-semibold mb-2">
                  ...
                  <Text className="text-hg-black500">
                    ...
                    estéticos validados para obtener los mejores resultados con
                    el menor tiempo de post-tratamiento posible.
                  </Text>
                </div>
                <div>
                  <Text size="xl" className="font-semibold mb-2">
                  ...
                  <Text className="text-hg-black500">
                    ...
                    cuidadosamente con criterios de calidad y seguridad para
