            ...
            <div className="md:flex md:flex-row gap-12 items-center">
              <Flex layout="col-left" className="md:w-1/2 mb-4 md:mb-0">
                ...
                <Text isAnimated size="xl" className="">
                  Holaglow es la nueva cara de la medicina estética que dice
                  adiós a los prejuicios y reafirma que la belleza es lo que a
                  ti te de la gana
                </Text>
              </Flex>
              ...
              <li className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div>
                  ...
                  <Text isAnimated className="text-hg-black500 md:text-lg">
                    ...
                    tus propias reglas. Creemos que la belleza real se basa en
                    la autenticidad.
                  </Text>
                </div>
              </li>
              ...
              <li className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div>
                  ...
                  <Text isAnimated className="text-hg-black500 md:text-lg">
                    ...
                    experiencia hecha a la medida de todas las personas que ven
                    en la medicina estética el mejor aliado para deslumbrar en
                    su día a día.
                  </Text>
                </div>
              </li>
