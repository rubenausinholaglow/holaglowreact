    ...
    <Container className="py-8 md:py-12">
      ...
      <Flex layout="col-left" className="gap-4">
        ...
        <p>
          ...
          que dispone el Reglamento (UE) 2016/679 de 27 de abril de 2016 (RGPD)
          relativo a la protección de las personas físicas en cuanto al
          ...
          personales, Europea o Nacional, le informa de que tiene implementadas
          las medidas de seguridad necesarias, de índole técnica y
          organizativas, para garantizar y proteger la confidencialidad,
        ...
        <ul className="pl-8 flex flex-col gap-4 list-disc">
          ...
          <li>
            <p>
              ...
              electrónica, para obtener su opinión sobre el servicio prestado y,
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              Se realizarán análisis de perfiles y de usabilidad, tanto del uso
              de la herramienta como de la página Web, mediante la implantación
              de cookies.
            </p>
          </li>
          <li>
            <p>
              Los datos de clientes y/o de proveedores serán tratados, dentro de
              la relación contractual que les vincula con el responsable, en
          ...
          <li>
            <p>
              ...
              es la de proporcionar seguridad en el entorno de la empresa tanto
              a trabajadores como a visitantes.
            </p>
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          las comunicaciones que recibirá de GLOW LAB, S.L., el usuario tiene la
        ...
        <p>
          ...
          datos personales identificativos y del tráfico durante el plazo máximo
          de 2 años para el caso de que fuera requerido por los Jueces y
          Tribunales o para incoar acciones internas derivadas del uso indebido
          de la página web.
        </p>
        <p>
        ...
        <p>
          Cualquier comunicación remitida quedará incorporada a los sistemas de
          información de GLOW LAB, S.L., Al aceptar las presentes condiciones,
          términos y políticas, el Usuario consiente expresamente a que realice
          las siguientes actividades y/o acciones, salvo que el Usuario indique
          lo contrario:
        </p>
        <ul className="pl-8 flex flex-col gap-4 list-disc">
          <li>
            <p>
              ...
              actividades, servicios, promociones, publicidad, noticias, ofertas
              y demás información sobre los servicios y productos relacionados
              con la actividad.
            </p>
          </li>
          <li>
            <p>
              ...
              comunicaciones comerciales por vía electrónica, el envío de dichas
              comunicaciones por medios electrónicos informando a los Usuarios
              de las actividades, servicios, promociones, publicidad, noticias,
              ofertas y demás información sobre los servicios y productos de
              iguales o similares a los que fueron inicialmente objeto de
              contratación o de interés por el Usuario.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          comunicarse con clientes y otros afectados es el teléfono corporativo,
        ...
        <p>
          ...
          responsabilidad en relación con las medidas de seguridad que disponga
        ...
        <p>
          Así mismo, el prestador facilitará información a las fuerzas y cuerpos
          de seguridad bajo orden judicial o por obligación de una norma legal,
          sin perjuicio de poder bloquear o cancelar su cuenta si puede haber
          indicios de la comisión de algún delito por parte del usuario.
        </p>
        <p>
          La información facilitada será solamente la que disponga en este
          momento el prestador. La información que usted nos proporcione tanto a
          través de este sitio web como a través de la aplicación será alojada
          en los servidores de GLOW LAB, S.L.
        </p>
        <p className="font-semibold pt-6 mt-6 border-t border-hg-black300 w-full">
        ...
        <p>
          ...
          siguientes derechos ante presentando un escrito a la dirección postal
          del encabezamiento o enviando un correo electrónico a
          legal@holaglow.com, indicando como Asunto: “RGPD, Derechos afectado”,
          y adjuntando fotocopia de su DNI o cualquier medio análogo en derecho,
        ...
        <ul className="pl-8 flex flex-col gap-4 list-disc">
          ...
          <li>
            <p>
              ...
              cabo el tratamiento de sus datos de carácter personal o se cese en
              el mismo.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              ...
              tratamiento al interesado, a fin de que éste pueda transmitirlos a
          ...
          <li>
            <p>
              ...
              (incluida la elaboración de perfiles): derecho a no ser objeto de
              una decisión basada en el tratamiento auto- 03 matizado que
        ...
        <p>
          ...
          consentimiento. También tiene derecho a presentar una reclamación ante
          la autoridad de control si considera que pueden haberse visto
        ...
        <ul className="pl-8 flex flex-col gap-4 list-disc">
          ...
          <li>
            <p>
              Datos facilitados por los clientes destinatarios de los servicios,
              por cualquier medio.
            </p>
          </li>
        </ul>
        <p>
          ...
          representantes legales mediante la firma de los formularios realizados
          al efecto por los centros en los cuales los menores forman parte.
        </p>
        <p className="font-semibold pt-6 mt-6 border-t border-hg-black300 w-full">
          Videovigilancia
        </p>
        <p>
          ...
          fines indicados en el apartado de finalidades de la presente política
          de privacidad y/o a petición de autoridades.
        </p>
        <p>
          ...
          previo a la cámara y suficientemente visible que informa que el lugar
          es un establecimiento videovigilado.
        </p>
        <p>
          Las imágenes captadas por las cámaras se limitarán al establecimiento
          público de que se trate. No se captarán imágenes de la vía pública a
          excepción de una franja mínima de los accesos al establecimiento.
        </p>
        <p>
          ...
          autorizada y serán conservadas durante un plazo máximo de un mes desde
          su captación.
        </p>
        <p className="font-semibold pt-6 mt-6 border-t border-hg-black300 w-full">
          Redes sociales
        ...
        <p>
          ...
          cualquier vínculo o acción de conexión a través de las redes sociales)
          de las páginas oficiales de GLOW LAB, S.L. se regirá por este
          ...
          proceda en cada caso y aceptadas previamente por el usuario.
        </p>
        <p>
        ...
        <p>
          Que sean presuntamente ilícitos por la normativa nacional, comunitaria
          o internacional o que realicen actividades presuntamente ilícitas o
          contravengan los principios de la buena fe.
        </p>
        <p>
          Que atenten contra los derechos fundamentales de las personas, falten
          a la cortesía en la red, molesten o puedan generar opiniones negativas
          en nuestros usuarios o terceros y en general cualesquiera sean los
          contenidos que considere inapropiados.
        </p>
        <p>
        ...
        <p>
          ...
          las medidas de seguridad aplicables a la presente plataforma, debiendo
          el usuario en caso de querer conocerlas, consultar las
        ...
        <p>
          ...
          mismo, se garantiza también que el tratamiento y registro en ficheros,
          programas, sistemas o equipos, locales y centros cumplen con los
          requisitos y condiciones de integridad y seguridad establecidas en la
          normativa vigente.
        </p>
        <p className="font-semibold pt-6 mt-6 border-t border-hg-black300 w-full">
          Legislación
        ...
        <p>
          ...
          sometidos a la legislación y jurisdicción española a la que se someten
        ...
        <p>
          GLOW LAB, S.L. se reserva el derecho a modificar la presente política
