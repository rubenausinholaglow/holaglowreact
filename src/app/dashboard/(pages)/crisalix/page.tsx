...
const Page = () => {
  return (
    <section className='bg-hg-200 h-screen flex flex-col items-center'>
        <p className='text-3xl p-10'>Simulador 3D</p>
        <div className='grid grid-cols-2'>
            <div>
                <Image className='mx-auto p-10' src='/images/dashboard/menu-icons/3d_simulator.png' height='50' width='250' alt='3D Simulator' />
