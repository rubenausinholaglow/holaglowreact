    ...
    <div className="bg-hg-200 min-h-screen flex flex-col items-center justify-center p-10">
      {product ? (
        <div className="bg-white p-8 rounded shadow">
          <h1 className="text-black text-3xl font-bold mb-4">{product.title}</h1>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4" onClick={handleGoBack}>
            Volver
          </button>
        </div>
      ) : (
