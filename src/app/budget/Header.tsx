...
export default function Header({ clinicInfo }: { clinicInfo: Clinic }) {
  return (
    <header className='w-full p-8 pb-12 bg-[url("/images/budgetHeader.jpg")] bg-cover bg-right-bottom'>
      <Image className='mx-auto' src='/images/holaglow.svg' height='40' width='188' alt='Holaglow' />

      <Image src='/images/myGlowMyRules.svg' height='180' width='330' alt='My glow my rules' />
